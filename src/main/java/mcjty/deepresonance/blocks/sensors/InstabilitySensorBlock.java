...
public class InstabilitySensorBlock extends GenericDRBlock<InstabilitySensorTileEntity, EmptyContainer> {
    ...
    protected int getRedstoneOutput(IBlockState state, IBlockAccess world, BlockPos pos, EnumFacing side) {
        ...
        if (side == direction) {
            ...
            if (state.getBlock() instanceof InstabilitySensorBlock && te instanceof InstabilitySensorTileEntity) {
                InstabilitySensorTileEntity sensor = (InstabilitySensorTileEntity) te;
    ...
    public void addInformation(ItemStack itemStack, World player, List<String> list, ITooltipFlag advancedToolTip) {
        ...
        if (Keyboard.isKeyDown(Keyboard.KEY_LSHIFT) || Keyboard.isKeyDown(Keyboard.KEY_RSHIFT)) {
            ...
            list.add("some instability");
            list.add("The strength of this redstone signal");
            list.add("will increase if the instability is larger");
        } else {
